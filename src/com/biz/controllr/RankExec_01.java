...
public class RankExec_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * int 배열 intKor를 10개 생성하고 각각 의 값을 51~100까지 임의 값으로 세틸하고 세팅된 배열의 값을 오름 차순 정렬
		 */
		 ...
		 * 암호화 같은 특수한 용도에서 사용을 하는
		 * 수령, 집합
		 * 
		 * 하지만 컴퓨터에서 생성하는 난수는 컴퓨터 내부에서 특별한 연산을 통해 생성을 하다보니 유사한 값들이 나타난다. 그래서 컴퓨터에서 생성한
		 * 난수는 유사난수라고부르며 실험적인 용도로만 사용해야한다
		 */
